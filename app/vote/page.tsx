    ...
    <div className="min-h-screen pt-24 pb-32">
      <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
        ...
        >
          ...
          >
            Support <strong className="text-white">{siteConfig.name}</strong> by voting daily!
            Every vote helps us grow and rewards you with in-game keys, ranks, and more.
            <br />
            <span className="text-xs text-amber-400/80 mt-2 block flex items-center justify-center gap-1.5">
              <Sparkles className="w-3.5 h-3.5" />
              Top voters list auto-syncs every 1 hour to ensure peak server performance.
            </span>
          </motion.p>
        </motion.div>
