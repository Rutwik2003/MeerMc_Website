...
import { getLeaderboardData, formatPlaytime, formatNetWorth, SortKey } from "@/config/leaderboard";
...
export default function LeaderboardPage() {
  ...
  const players = useMemo(() => getLeaderboardData(sortBy), [sortBy]);
  ...
  // Auto-refresh countdown (visual only with mock data — becomes real with API)
  useEffect(() => {
    ...
    <div className="min-h-screen pt-24 pb-32">
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-14">
          ...
          >
            Top survivors of {siteConfig.name} • Season 1 • Updated live
          </motion.p>
